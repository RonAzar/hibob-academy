...
data class PetRecord(val petName: String, val petType: PetType, val dateOfArrival: LocalDate, val companyId: Long, val ownerId: Long?)
...
data class OwnerRecord(val ownerName: String, val employeeId: String, val companyId: Long)
